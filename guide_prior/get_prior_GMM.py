...
document_phecode_matrix = torch.load("./guide_prior/file/document_phecode_matrix.pt", map_location=device)  # get document-PheCode counts, D x K matrix
...
torch.save(alpha_prior, "./guide_prior/file/topic_prior_alpha.pt")
