...
topic_prior_alpha = torch.load("./guide_prior/file/topic_prior_alpha.pt", map_location=device)  # get topic prior alpha, D X K matrix
...
torch.save(exp_n_icd, "./guide_prior/init_tokens/init_exp_n_icd.pt")
torch.save(exp_s_icd, "./guide_prior/init_tokens/init_exp_s_icd.pt")
torch.save(topic_prior_alpha, "./guide_prior/init_tokens/init_exp_m.pt")
torch.save(exp_n_med, "./guide_prior/init_tokens/init_exp_n_med.pt")
torch.save(exp_n_cpt, "./guide_prior/init_tokens/init_exp_n_cpt.pt")
torch.save(exp_n_drg, "./guide_prior/init_tokens/init_exp_n_drg.pt")
torch.save(exp_n_lab, "./guide_prior/init_tokens/init_exp_n_lab.pt")
torch.save(exp_n_note, "./guide_prior/init_tokens/init_exp_n_note.pt")
